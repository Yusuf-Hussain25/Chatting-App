...
function Signup() {
  ...
  return (
    <>
      <div className="flex h-screen items-center justify-center bg-gradient-to-r from-blue-400 to-gray-600">
        <form
          onSubmit={handleSubmit(onSubmit)}
          className="border border-white px-6 py-2 rounded-md space-y-3 w-96"
        >
          <h1 className="text-2xl text-center">
            <span className="text-black font-semibold">Connectify </span>
          </h1>
